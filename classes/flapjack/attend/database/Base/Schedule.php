...
abstract class Schedule implements ActiveRecordInterface
{
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ($this->start_date === null || $dt === null || $dt->format(
                    "Y-m-d H:i:s.u"
                ) !== $this->start_date->format("Y-m-d H:i:s.u")) {
    ...
    public function setEnteredAt($v)
    {
        ...
        if ($this->entered_at !== null || $dt !== null) {
            if ($this->entered_at === null || $dt === null || $dt->format(
                    "Y-m-d H:i:s.u"
                ) !== $this->entered_at->format("Y-m-d H:i:s.u")) {
    ...
    public function hydrate(
        ...
        try {
            $col      = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ScheduleTableMap::translateFieldName(
                'Id',
            ...
            $col              = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ScheduleTableMap::translateFieldName(
                'StudentId',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $col            = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ScheduleTableMap::translateFieldName(
                'Schedule',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ScheduleTableMap::translateFieldName(
                'StartDate',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ScheduleTableMap::translateFieldName(
                'EnteredAt',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
