...
/**
 * Base class that represents a row from the 'group_permissions' table.
 *
 *
 *
...
abstract class GroupPermission implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\flapjack\\attend\\database\\Map\\GroupPermissionTableMap';
    ...
    /**
     * Initializes internal state of flapjack\attend\database\Base\GroupPermission object.
     */
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO group_permissions (%s) VALUES (%s)',
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(GroupPermissionTableMap::COL_PERMISSION_ID)) {
            $criteria->add(GroupPermissionTableMap::COL_PERMISSION_ID, $this->permission_id);
        }
    ...
    public function getPermission(?ConnectionInterface $con = null)
    {
        if ($this->aPermission === null && ($this->permission_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPermission->addGroupPermissions($this);
             */
        }
