...
abstract class GroupMemberQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'attend', $modelName = '\\flapjack\\attend\\database\\GroupMember', $modelAlias = null)
    {
    ...
    public function filterByAccount($account, ?string $comparison = null)
    {
        if ($account instanceof \flapjack\attend\database\Account) {
            ...
            $this
                ->addUsingAlias(GroupMemberTableMap::COL_ACCOUNT_ID, $account->toKeyValue('PrimaryKey', 'Id'), $comparison);
