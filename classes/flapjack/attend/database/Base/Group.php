...
abstract class Group implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\flapjack\\attend\\database\\Map\\GroupTableMap';
     ...
     * Description of the role or purpose of the group
    ...
    /**
     * Initializes internal state of flapjack\attend\database\Base\Group object.
     * @see applyDefaults()
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\flapjack\\attend\\database\\Group'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \flapjack\attend\database\Group (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \flapjack\attend\database\Group Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildGroupMember}> List of ChildGroupMember objects
     */
    public function getGroupMembersJoinAccount(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildGroupMemberQuery::create(null, $criteria);
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countGroupPermissions(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collGroupPermissionsPartial && !$this->isNew();
        if (null === $this->collGroupPermissions || null !== $criteria || $partial) {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildGroupPermission}> List of ChildGroupPermission objects
     */
    public function getGroupPermissionsJoinPermission(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildGroupPermissionQuery::create(null, $criteria);
