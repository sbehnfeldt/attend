...
abstract class Group implements ActiveRecordInterface
{
    ...
    public function hydrate(
        ...
        try {
            $col      = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GroupTableMap::translateFieldName(
                'Id',
            ...
            $col        = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GroupTableMap::translateFieldName(
                'Name',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $col               = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GroupTableMap::translateFieldName(
                'Description',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            throw new PropelException(
                sprintf('Error populating %s object', '\\flapjack\\attend\\database\\Group'),
                0,
                $e
            );
        }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildGroupQuery::create(null, $this->buildPkeyCriteria())->setFormatter(
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null !== $this->id) {
            throw new PropelException(
                'Cannot insert a value for auto-increment primary key (' . GroupTableMap::COL_ID . ')'
            );
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildGroupMember}> List of ChildGroupMember objects
     */
    public function getGroupMembersJoinAccount(
        ?Criteria $criteria = null,
        ?ConnectionInterface $con = null,
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildGroupPermission}> List of ChildGroupPermission objects
     */
    public function getGroupPermissionsJoinPermission(
        ?Criteria $criteria = null,
        ?ConnectionInterface $con = null,
        $joinBehavior = Criteria::LEFT_JOIN
    ) {
