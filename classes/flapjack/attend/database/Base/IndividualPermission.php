...
/**
 * Base class that represents a row from the 'individual_permissions' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class IndividualPermission implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\flapjack\\attend\\database\\Map\\IndividualPermissionTableMap';
    ...
    /**
     * Initializes internal state of flapjack\attend\database\Base\IndividualPermission object.
     */
    ...
    /**
     * Compares this with another <code>IndividualPermission</code> instance.  If
     * <code>obj</code> is an instance of <code>IndividualPermission</code>, delegates to
    ...
    public function setAccountId($v)
    {
        ...
        if ($this->account_id !== $v) {
            $this->account_id = $v;
            $this->modifiedColumns[IndividualPermissionTableMap::COL_ACCOUNT_ID] = true;
        }
    ...
    public function setPermissionsId($v)
    {
        ...
        if ($this->permissions_id !== $v) {
            ...
            $this->modifiedColumns[IndividualPermissionTableMap::COL_PERMISSIONS_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : IndividualPermissionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : IndividualPermissionTableMap::translateFieldName('AccountId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->account_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : IndividualPermissionTableMap::translateFieldName('PermissionsId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = IndividualPermissionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\flapjack\\attend\\database\\IndividualPermission'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildIndividualPermissionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @see IndividualPermission::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildIndividualPermissionQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                IndividualPermissionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[IndividualPermissionTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . IndividualPermissionTableMap::COL_ID . ')');
        }
        ...
        if ($this->isColumnModified(IndividualPermissionTableMap::COL_PERMISSIONS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'permissions_id';
        }

        $sql = sprintf(
            'INSERT INTO individual_permissions (%s) VALUES (%s)',
    ...
    {
        $pos = IndividualPermissionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['IndividualPermission'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['IndividualPermission'][$this->hashCode()] = true;
        $keys = IndividualPermissionTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(IndividualPermissionTableMap::COL_ID)) {
            $criteria->add(IndividualPermissionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(IndividualPermissionTableMap::COL_ACCOUNT_ID)) {
            $criteria->add(IndividualPermissionTableMap::COL_ACCOUNT_ID, $this->account_id);
        }
        if ($this->isColumnModified(IndividualPermissionTableMap::COL_PERMISSIONS_ID)) {
            $criteria->add(IndividualPermissionTableMap::COL_PERMISSIONS_ID, $this->permissions_id);
        }
    ...
    {
        $criteria = ChildIndividualPermissionQuery::create();
        $criteria->add(IndividualPermissionTableMap::COL_ID, $this->id);
    ...
    public function setAccount(ChildAccount $v = null)
    {
        ...
        if ($v !== null) {
            $v->addIndividualPermission($this);
        }
    ...
    public function getAccount(?ConnectionInterface $con = null)
    {
        if ($this->aAccount === null && ($this->account_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAccount->addIndividualPermissions($this);
             */
        }
    ...
    public function getPermission(?ConnectionInterface $con = null)
    {
        if ($this->aPermission === null && ($this->permissions_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPermission->addIndividualPermissions($this);
             */
        }
    ...
    {
        if (null !== $this->aAccount) {
            $this->aAccount->removeIndividualPermission($this);
        }
        if (null !== $this->aPermission) {
            $this->aPermission->removeIndividualPermission($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(IndividualPermissionTableMap::DEFAULT_STRING_FORMAT);
    }
