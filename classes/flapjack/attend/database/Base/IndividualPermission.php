...
abstract class IndividualPermission implements ActiveRecordInterface
{
    ...
    public function hydrate(
        ...
        try {
            $col      = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : IndividualPermissionTableMap::translateFieldName(
                'Id',
            ...
            $col              = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : IndividualPermissionTableMap::translateFieldName(
                'AccountId',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $col                  = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : IndividualPermissionTableMap::translateFieldName(
                'PermissionsId',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildIndividualPermissionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(
    ...
    public function toArray(
        ...
        $keys                                                            = IndividualPermissionTableMap::getFieldNames(
            $keyType
        );
        $result                                                          = [
            $keys[0] => $this->getId(),
