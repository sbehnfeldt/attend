...
abstract class PermissionQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'attend', $modelName = '\\flapjack\\attend\\database\\Permission', $modelAlias = null)
    {
    ...
    public function filterByGroupPermission($groupPermission, ?string $comparison = null)
    {
        if ($groupPermission instanceof \flapjack\attend\database\GroupPermission) {
            ...
            throw new PropelException('filterByGroupPermission() only accepts arguments of type \flapjack\attend\database\GroupPermission or Collection');
        }
    }
    ...
    public function useGroupPermissionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'GroupPermission', '\flapjack\attend\database\GroupPermissionQuery');
    }
