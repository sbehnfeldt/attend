...
abstract class LoginAttempt implements ActiveRecordInterface
{
    ...
    public function hydrate(
        ...
        try {
            $col      = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LoginAttemptTableMap::translateFieldName(
                'Id',
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LoginAttemptTableMap::translateFieldName(
                'AttemptedAt',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $col            = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LoginAttemptTableMap::translateFieldName(
                'Username',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $col        = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : LoginAttemptTableMap::translateFieldName(
                'Pass',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $col        = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : LoginAttemptTableMap::translateFieldName(
                'Note',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            throw new PropelException(
                sprintf('Error populating %s object', '\\flapjack\\attend\\database\\LoginAttempt'), 0, $e);
        }
    }
