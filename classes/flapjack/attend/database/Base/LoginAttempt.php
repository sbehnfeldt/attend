...
abstract class LoginAttempt implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\flapjack\\attend\\database\\Map\\LoginAttemptTableMap';
    ...
    /**
     * Initializes internal state of flapjack\attend\database\Base\LoginAttempt object.
     */
    ...
    /**
     * Get the [attempted_at] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [logged_out_at] column value.
     *
     * @return string|null
     */
    public function getLoggedOutAt()
    {
    ...
    /**
     * Set the value of [attempted_at] column.
     *
    ...
    /**
     * Set the value of [logged_out_at] column.
     *
    ...
    public function setLoggedOutAt($v)
    {
        ...
        if ($this->logged_out_at !== $v) {
            $this->logged_out_at = $v;
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $this->attempted_at = (null !== $col) ? (string) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : LoginAttemptTableMap::translateFieldName('LoggedOutAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->logged_out_at = (null !== $col) ? (string) $col : null;
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\flapjack\\attend\\database\\LoginAttempt'), 0, $e);
        }
    }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'attempted_at':
                        $stmt->bindValue($identifier, $this->attempted_at, PDO::PARAM_INT);
                    ...
                    case 'note':
                        ...
                        break;
                    case 'logged_out_at':
                        $stmt->bindValue($identifier, $this->logged_out_at, PDO::PARAM_INT);
     ...
     * objects.
     *
     * @param object $copyObj An object of \flapjack\attend\database\LoginAttempt (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \flapjack\attend\database\LoginAttempt Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
