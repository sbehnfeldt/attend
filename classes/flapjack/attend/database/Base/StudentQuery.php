 ...
 *
 * @method     \flapjack\attend\database\ClassroomQuery|\flapjack\attend\database\AttendanceQuery|\flapjack\attend\database\ScheduleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class StudentQuery extends ModelCriteria
{
    ...
    {
        if ($attendance instanceof \flapjack\attend\database\Attendance) {
            $this
    ...
    public function useAttendanceQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Attendance', '\flapjack\attend\database\AttendanceQuery');
    }
