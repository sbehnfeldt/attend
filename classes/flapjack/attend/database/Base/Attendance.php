...
abstract class Attendance implements ActiveRecordInterface
{
    ...
    public function setCheckIn($v)
    {
        ...
        if ($this->check_in !== null || $dt !== null) {
            if ($this->check_in === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->check_in->format("Y-m-d H:i:s.u")) {
    ...
    public function setCheckOut($v)
    {
        ...
        if ($this->check_out !== null || $dt !== null) {
            if ($this->check_out === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->check_out->format("Y-m-d H:i:s.u")) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'student_id':
                        ...
                        break;
                    case 'check_in':
                        $stmt->bindValue($identifier, $this->check_in ? $this->check_in->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);

                        break;
                    case 'check_out':
                        $stmt->bindValue($identifier, $this->check_out ? $this->check_out->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
