...
abstract class Attendance implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\flapjack\\attend\\database\\Map\\AttendanceTableMap';
    ...
    /**
     * Initializes internal state of flapjack\attend\database\Base\Attendance object.
     */
    ...
    public function getCheckIn($format = null)
    {
        if ($format === null) {
            ...
            return $this->check_in instanceof \DateTimeInterface ? $this->check_in->format($format) : null;
        }
    }
    ...
    public function getCheckOut($format = null)
    {
        if ($format === null) {
            ...
            return $this->check_out instanceof \DateTimeInterface ? $this->check_out->format($format) : null;
        }
    }
    ...
    public function setCheckIn($v)
    {
        ...
        if ($this->check_in !== null || $dt !== null) {
            if ($this->check_in === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->check_in->format(
                    "Y-m-d H:i:s.u"
                )) {
                $this->check_in                                          = $dt === null ? null : clone $dt;
    ...
    public function setCheckOut($v)
    {
        ...
        if ($this->check_out !== null || $dt !== null) {
            if ($this->check_out === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->check_out->format(
                    "Y-m-d H:i:s.u"
                )) {
                $this->check_out                                          = $dt === null ? null : clone $dt;
    ...
    public function hydrate(
        ...
        try {
            $col      = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AttendanceTableMap::translateFieldName(
                'Id',
            ...
            $col              = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AttendanceTableMap::translateFieldName(
                'StudentId',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AttendanceTableMap::translateFieldName(
                'CheckIn',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $this->check_in = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AttendanceTableMap::translateFieldName(
                'CheckOut',
                TableMap::TYPE_PHPNAME,
                $indexType
            )];
            ...
            $this->check_out = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
     ...
     * objects.
     *
     * @param  object  $copyObj  An object of \flapjack\attend\database\Attendance (or compatible) type.
     ...
     *
     * @param  bool  $deepCopy  Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \flapjack\attend\database\Attendance Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
