...
class StudentTableMap extends TableMap
{
    ...
    public function initialize(): void
    {
        ...
        $this->addColumn('family_name', 'FamilyName', 'VARCHAR', true, 255, null);
        $this->addColumn('first_name', 'FirstName', 'VARCHAR', true, 255, null);
        $this->addColumn('enrolled', 'Enrolled', 'BOOLEAN', true, 1, null);
        $this->addForeignKey('classroom_id', 'ClassroomId', 'INTEGER', 'classrooms', 'id', true, null, null);
    }
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Attendance', '\\flapjack\\attend\\database\\Attendance', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':student_id',
    1 => ':id',
