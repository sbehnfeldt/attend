...
class GroupPermissionTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [GroupPermissionTableMap::COL_ID, GroupPermissionTableMap::COL_GROUP_ID, GroupPermissionTableMap::COL_PERMISSION_ID, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [GroupPermissionTableMap::COL_ID => 0, GroupPermissionTableMap::COL_GROUP_ID => 1, GroupPermissionTableMap::COL_PERMISSION_ID => 2, ],
