...
use flapjack\attend\database\GroupPermission;
use flapjack\attend\database\GroupPermissionQuery;


/**
 * This class defines the structure of the 'group_permissions' table.
 *
 *
 *
...
class GroupPermissionTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.GroupPermissionTableMap';
     ...
     */
    public const TABLE_NAME = 'group_permissions';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'GroupPermission';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\flapjack\\attend\\database\\GroupPermission';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'GroupPermission';
     ...
     */
    public const COL_ID = 'group_permissions.id';

    /**
     * the column name for the group_id field
     */
    public const COL_GROUP_ID = 'group_permissions.group_id';

    /**
     * the column name for the permission_id field
     */
    public const COL_PERMISSION_ID = 'group_permissions.permission_id';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME   => ['Id', 'GroupId', 'PermissionId',],
        self::TYPE_CAMELNAME => ['id', 'groupId', 'permissionId',],
        self::TYPE_COLNAME   => [
            GroupPermissionTableMap::COL_ID,
            GroupPermissionTableMap::COL_GROUP_ID,
            GroupPermissionTableMap::COL_PERMISSION_ID,
        ],
        self::TYPE_FIELDNAME => ['id', 'group_id', 'permission_id',],
        self::TYPE_NUM       => [0, 1, 2,]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME   => ['Id' => 0, 'GroupId' => 1, 'PermissionId' => 2,],
        self::TYPE_CAMELNAME => ['id' => 0, 'groupId' => 1, 'permissionId' => 2,],
        self::TYPE_COLNAME   => [
            GroupPermissionTableMap::COL_ID            => 0,
            GroupPermissionTableMap::COL_GROUP_ID      => 1,
            GroupPermissionTableMap::COL_PERMISSION_ID => 2,
        ],
        self::TYPE_FIELDNAME => ['id' => 0, 'group_id' => 1, 'permission_id' => 2,],
        self::TYPE_NUM       => [0, 1, 2,]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id'                                         => 'ID',
        'groupPermission.id'                         => 'ID',
        'GroupPermissionTableMap::COL_ID'            => 'ID',
        'COL_ID'                                     => 'ID',
        'group_permissions.id'                       => 'ID',
        'GroupId'                                    => 'GROUP_ID',
        'GroupPermission.GroupId'                    => 'GROUP_ID',
        'groupId'                                    => 'GROUP_ID',
        'groupPermission.groupId'                    => 'GROUP_ID',
        'GroupPermissionTableMap::COL_GROUP_ID'      => 'GROUP_ID',
        'COL_GROUP_ID'                               => 'GROUP_ID',
        'group_id'                                   => 'GROUP_ID',
        'group_permissions.group_id'                 => 'GROUP_ID',
        'PermissionId'                               => 'PERMISSION_ID',
        'GroupPermission.PermissionId'               => 'PERMISSION_ID',
        'permissionId'                               => 'PERMISSION_ID',
        'groupPermission.permissionId'               => 'PERMISSION_ID',
        'GroupPermissionTableMap::COL_PERMISSION_ID' => 'PERMISSION_ID',
    ...
    {
        // attributes
        $this->setName('group_permissions');
        $this->setPhpName('GroupPermission');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\flapjack\\attend\\database\\GroupPermission');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addForeignKey('group_id', 'GroupId', 'INTEGER', 'groups', 'id', true, null, null);
        $this->addForeignKey('permission_id', 'PermissionId', 'INTEGER', 'permissions', 'id', true, null, null);
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupPermissionTableMap::COL_PERMISSION_ID);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(GroupPermissionTableMap::COL_ID);
            $criteria->removeSelectColumn(GroupPermissionTableMap::COL_GROUP_ID);
            $criteria->removeSelectColumn(GroupPermissionTableMap::COL_PERMISSION_ID);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(GroupPermissionTableMap::DATABASE_NAME)->getTable(
            GroupPermissionTableMap::TABLE_NAME);
    }
    ...
    public static function doDelete($values, ?ConnectionInterface $con = null): int
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \flapjack\attend\database\GroupPermission) { // it's a model object
    ...
    public static function doInsert($criteria, ?ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(GroupPermissionTableMap::COL_ID) && $criteria->keyContainsValue(
                GroupPermissionTableMap::COL_ID
            )) {
