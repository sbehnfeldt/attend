...
use flapjack\attend\database\Group;
use flapjack\attend\database\GroupQuery;
...
class GroupTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.GroupTableMap';
     ...
     */
    public const OM_CLASS = '\\flapjack\\attend\\database\\Group';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Group';
     ...
     */
    public const COL_DESCRIPTION = 'groups.description';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME   => [GroupTableMap::COL_ID, GroupTableMap::COL_NAME, GroupTableMap::COL_DESCRIPTION,],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME   => [
            GroupTableMap::COL_ID          => 0,
            GroupTableMap::COL_NAME        => 1,
            GroupTableMap::COL_DESCRIPTION => 2,
        ],
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\flapjack\\attend\\database\\Group');
        $this->setPackage('');
    ...
    public function buildRelations(): void
    {
        ...
        $this->addRelation(
            'GroupPermission',
            '\\flapjack\\attend\\database\\GroupPermission',
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(GroupTableMap::DATABASE_NAME)->getTable(
            GroupTableMap::TABLE_NAME);
    }
    ...
    public static function doDelete($values, ?ConnectionInterface $con = null): int
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \flapjack\attend\database\Group) { // it's a model object
