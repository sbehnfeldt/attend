...
class AccountTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Attend\\Database\\Account';
     ...
     */
    const COL_USERNAME = 'accounts.username';

    /**
     * the column name for the pwhash field
     */
    const COL_PWHASH = 'accounts.pwhash';
    ...
    protected static $fieldNames = array(
        self::TYPE_PHPNAME => array('Id', 'Username', 'Pwhash', 'Email', 'Role',),
        self::TYPE_CAMELNAME => array('id', 'username', 'pwhash', 'email', 'role',),
        self::TYPE_COLNAME => array(AccountTableMap::COL_ID, AccountTableMap::COL_USERNAME, AccountTableMap::COL_PWHASH, AccountTableMap::COL_EMAIL, AccountTableMap::COL_ROLE,),
        self::TYPE_FIELDNAME => array('id', 'username', 'pwhash', 'email', 'role',),
    ...
    protected static $fieldKeys = array(
        self::TYPE_PHPNAME => array('Id' => 0, 'Username' => 1, 'Pwhash' => 2, 'Email' => 3, 'Role' => 4,),
        self::TYPE_CAMELNAME => array('id' => 0, 'username' => 1, 'pwhash' => 2, 'email' => 3, 'role' => 4,),
        self::TYPE_COLNAME => array(AccountTableMap::COL_ID => 0, AccountTableMap::COL_USERNAME => 1, AccountTableMap::COL_PWHASH => 2, AccountTableMap::COL_EMAIL => 3, AccountTableMap::COL_ROLE => 4,),
        self::TYPE_FIELDNAME => array('id' => 0, 'username' => 1, 'pwhash' => 2, 'email' => 3, 'role' => 4,),
        self::TYPE_NUM => array(0, 1, 2, 3, 4,)
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Attend\\Database\\Account');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('username', 'Username', 'VARCHAR', true, 45, null);
        $this->addColumn('pwhash', 'Pwhash', 'VARCHAR', true, 60, null);
    ...
    public static function doDelete($values, ConnectionInterface $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Attend\Database\Account) { // it's a model object
