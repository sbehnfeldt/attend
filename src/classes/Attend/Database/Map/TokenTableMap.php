...
class TokenTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Attend\\Database\\Token';
     ...
     */
    const COL_ACCOUNT_ID = 'token_auths.account_id';
    ...
    protected static $fieldNames = array(
        self::TYPE_PHPNAME => array('Id', 'CookieHash', 'Expires', 'AccountId',),
        self::TYPE_CAMELNAME => array('id', 'cookieHash', 'expires', 'accountId',),
        self::TYPE_COLNAME => array(TokenTableMap::COL_ID, TokenTableMap::COL_COOKIE_HASH, TokenTableMap::COL_EXPIRES, TokenTableMap::COL_ACCOUNT_ID,),
        self::TYPE_FIELDNAME => array('id', 'cookie_hash', 'expires', 'account_id',),
    ...
    protected static $fieldKeys = array(
        self::TYPE_PHPNAME => array('Id' => 0, 'CookieHash' => 1, 'Expires' => 2, 'AccountId' => 3,),
        self::TYPE_CAMELNAME => array('id' => 0, 'cookieHash' => 1, 'expires' => 2, 'accountId' => 3,),
        self::TYPE_COLNAME => array(TokenTableMap::COL_ID => 0, TokenTableMap::COL_COOKIE_HASH => 1, TokenTableMap::COL_EXPIRES => 2, TokenTableMap::COL_ACCOUNT_ID => 3,),
        self::TYPE_FIELDNAME => array('id' => 0, 'cookie_hash' => 1, 'expires' => 2, 'account_id' => 3,),
        self::TYPE_NUM => array(0, 1, 2, 3,)
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Attend\\Database\\Token');
        $this->setPackage('');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TokenTableMap::COL_COOKIE_HASH);
            $criteria->addSelectColumn(TokenTableMap::COL_EXPIRES);
            $criteria->addSelectColumn(TokenTableMap::COL_ACCOUNT_ID);
        } else {
    ...
    public static function doDelete($values, ConnectionInterface $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Attend\Database\Token) { // it's a model object
