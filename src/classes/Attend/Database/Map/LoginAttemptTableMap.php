...
class LoginAttemptTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Attend\\Database\\LoginAttempt';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Attend\\Database\\LoginAttempt');
        $this->setPackage('');
    ...
    public static function doDelete($values, ConnectionInterface $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Attend\Database\LoginAttempt) { // it's a model object
