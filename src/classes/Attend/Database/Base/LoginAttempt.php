...
use \Exception;
use \PDO;
use Attend\Database\LoginAttemptQuery as ChildLoginAttemptQuery;
use Attend\Database\Map\LoginAttemptTableMap;
...
abstract class LoginAttempt implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Attend\\Database\\Map\\LoginAttemptTableMap';
    ...
    /**
     * Initializes internal state of Attend\Database\Base\LoginAttempt object.
     * @see applyDefaults()
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Attend\Database\LoginAttempt
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Attend\Database\LoginAttempt The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param object $copyObj An object of \Attend\Database\LoginAttempt (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Attend\Database\LoginAttempt Clone of current object.
     * @throws PropelException
     */
