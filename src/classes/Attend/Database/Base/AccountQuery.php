...
use \Exception;
use \PDO;
use Attend\Database\Account as ChildAccount;
 ...
 * @method     ChildAccount findOneByPwhash(string $pwhash) Return the first ChildAccount filtered by the pwhash column
 ...
 * @method     ChildAccount[]|ObjectCollection findByPwhash(string $pwhash) Return ChildAccount objects filtered by the pwhash column
...
abstract class AccountQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Attend\Database\Base\AccountQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'attend', $modelName = '\\Attend\\Database\\Account', $modelAlias = null)
    {
     ...
     * </code>
     *
     * @param string $pwhash The value to use as filter.
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildAccountQuery The current query, for fluid interface
     */
    public function filterByPwhash($pwhash = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($pwhash)) {
                $comparison = Criteria::IN;
        ...
        return $this->addUsingAlias(AccountTableMap::COL_PWHASH, $pwhash, $comparison);
    }
