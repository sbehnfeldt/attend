...
use \Exception;
use \PDO;
use Attend\Database\AccountQuery as ChildAccountQuery;
use Attend\Database\Map\AccountTableMap;
...
abstract class Account implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Attend\\Database\\Map\\AccountTableMap';
    ...
    /**
     * Initializes internal state of Attend\Database\Base\Account object.
     */
     ...
     * @return $this|\Attend\Database\Account The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Attend\\Database\\Account'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Attend\Database\Account
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Attend\Database\Account The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param object $copyObj An object of \Attend\Database\Account (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Attend\Database\Account Clone of current object.
     * @throws PropelException
     */
